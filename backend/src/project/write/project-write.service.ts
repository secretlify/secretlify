...
export class ProjectWriteService {
  ...
  public async create(dto: CreateProjectDto): Promise<ProjectNormalized> {
    const mappedEncryptedPassphrases = Object.fromEntries(
      Object.entries(dto.encryptedPassphrases).map(([key, value]) => [
    ...
    const project = await this.projectModel.create({
      ...
      encryptedPassphrases: mappedEncryptedPassphrases,
